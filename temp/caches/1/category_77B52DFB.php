...
<div class="blank"></div>
 <div id="ur_here">
当前位置: <a href=".">首页</a> <code>&gt;</code> <a href="category.php?id=391">家居</a> <code>&gt;</code> <a href="category.php?id=392">户外鞋服</a> <code>&gt;</code> <a href="category.php?id=395">户外配饰</a> 
</div>
</div>
<div class="blank"></div>
...
<div class="box1 cate" id="cate"> 
  ...
  <a   style="border-top:none"  href="category.php?id=393" class="  f_ll" >户外服装</a>
  ...
  <a   href="category.php?id=394" class="  f_ll" >户外鞋袜</a>
  <ul style="display:none" >
      </ul>
  <div style="clear:both"></div>
  ...
  <a   href="category.php?id=395" class="  f_ll" >户外配饰</a>
  <ul style="display:none" >
      </ul>
  <div style="clear:both"></div>
...
<div class="box">
 <div class="box_1">
  ...
  <form method="GET" class="sort" name="listform">
    ...
    <li>  <a href="category.php?category=395&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=goods_id&order=ASC#goods_list">
    <img src="themes/ecmoban_zsxn/images/goods_id_DESC.gif" alt="按上架时间排序"></a>
    </li>
    <li>  <a href="category.php?category=395&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=shop_price&order=ASC#goods_list">
    <img src="themes/ecmoban_zsxn/images/shop_price_default.gif" alt="按价格排序"></a>
    </li>
    <li>  <a href="category.php?category=395&display=grid&brand=0&price_min=0&price_max=0&filter_attr=0&page=1&sort=last_update&order=DESC#goods_list">
    ...
    <div id="footer" style="width:1px; height:1px; overflow:hidden;">
      <div class="text"> &copy; 2005-2017 威生活 版权所有，并保留所有权利。<br />
        ...
        45ea207d7a2b68c49582d2d22adf953aquery_info|a:1:{s:4:"name";s:10:"query_info";}45ea207d7a2b68c49582d2d22adf953a<br />
                <div align="left"  id="rss"><a href="feed.php?cat=395"><img src="themes/ecmoban_zsxn/images/xml_rss2.gif" alt="rss" /></a></div>
      </div>
    </div>
